"""Asset Management Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="IT asset management agent that tracks hardware and software assets throughout their lifecycle, manages procurement workflows, monitors license compliance, forecasts refresh cycles, and generates asset reports.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
