"""Asset Management Agent - Main Agent Implementation."""
...
class AssetManagementAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.asset_tracking_enabled = True
        self.lifecycle_management_enabled = True
        self.license_compliance_enabled = True
        self.procurement_workflow_enabled = True
        self.refresh_forecasting_enabled = True
        self._tool_dispatch = {
            "register_asset": self.tools.register_asset,
            "track_lifecycle": self.tools.track_lifecycle,
            "check_license_compliance": self.tools.check_license_compliance,
            "forecast_refresh": self.tools.forecast_refresh,
            "generate_asset_report": self.tools.generate_asset_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['asset_tracking', 'lifecycle_management', 'license_compliance', 'procurement_workflow', 'refresh_forecasting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "check_license_compliance": ['check', 'license', 'compliance'],
            "forecast_refresh": ['forecast', 'refresh'],
            "generate_asset_report": ['generate', 'asset', 'report'],
        }
